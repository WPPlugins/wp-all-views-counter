=== Plugin Name ===
Contributors: sergpost3
Donate link: http://krigus.com/
Tags: count, counter, post views, postviews, views, page views, pageviews, page view count, post view count
...
1. Use the Settings->Page Views screen to configure the plugin
...
1. Plugin Settings
2. Show views in admin panel while editing post
3. Show views with additional statistic for authorized users
4. Widget Settings
5. Widget in frontend of site
